...
It will prompt for name, email, and password, then create (or promote) a verified admin user.

You can also pass values directly:

```bash
npm run create-admin -- --name "Admin" --email "admin@example.com" --password "strongpass123"
```
